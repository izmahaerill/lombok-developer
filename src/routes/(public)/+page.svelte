...
<section class=" container flex min-h-screen flex-col items-center justify-center gap-10 lg:flex-row-reverse">
  ...
  <div class="w-full">
    ...
    <p class="mb-10 leading-relaxed">
      Website Development Services from Lombok Developer, ready to help you master the online world.
...
<div class="container">
  <section
    class="flex min-h-screen flex-col items-center justify-center gap-10 lg:flex-row-reverse">
    <div class="w-full">
  ...
  <section class="mb-40 flex flex-col items-center justify-center gap-10 lg:flex-row">
    <div class="w-full">
    ...
    <div class="w-full">
      ...
      <p class="text-justify leading-relaxed">
        Lombok Developer is a group of young people who are creative in interactive multimedia and
        use it to develop information technology in Lombok and Mataram. They aim to improve people's
  ...
  <section class="mb-32 flex flex-col items-center text-center">
    <h2 class="mb-5 text-3xl font-bold md:text-4xl">
      <span class="bg-gradient-to-l from-primary to-neutral bg-clip-text text-transparent">
    ...
    <p class="mb-10 leading-relaxed">
      Are you looking for website development services in Lombok? Lombok Developer is here to
      provide business friends, SMEs, and professionals in Lombok with effective website solutions
      according to your target market. Our services include graphic design, web development, web
      design templates, custom web programming, SEO services, etc.
    </p>
