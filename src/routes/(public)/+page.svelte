...
<div class="w-full">
  <section
    class="flex container min-h-screen flex-col items-center justify-center gap-10 lg:flex-row-reverse">
    <div class="w-full">
  ...
  <section class="mb-40 container flex flex-col items-center justify-center gap-10 lg:flex-row">
    <div class="w-full">
